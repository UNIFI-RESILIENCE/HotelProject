...
public class RoomViewIT extends AssertJSwingJUnitTestCase {
   ...
   public void testAddButtonError() {
       ...
       window.textBox("txtRoomNumber").enterText("101");
       window.textBox("txtRoomDescription").enterText("Duplicate Room");
       window.button(JButtonMatcher.withText("Publish Room")).click();
       ...
       window.label("lbDisplayStatus")
           .requireText("Room already exist 101: " + new Room("101", "Existing Room"));
   }
   ...
   public void testDeleteButtonSuccess() {
       ...
       GuiActionRunner.execute(() ->
           roomController.newRoom(new Room("101", "To Be Removed"))
       );
       // Select the room from the list and delete it
       window.list("lstDisplayRooms").selectItem(0);
   ...
   public void testDeleteButtonError() {
       ...
       GuiActionRunner.execute(() ->
           hotelRoomView.getListRoomModel().addElement(room)
       );
       ...
       assertThat(window.list("lstDisplayRooms").contents())
           .containsExactly(room.toString());

       // Verify that the error message is displayed
       window.label("lbDisplayStatus")
           .requireText("Room not found 999: " + room);
   }
   ...
   public void testAddRoom() {
       ...
       assertThat(roomRepository.findById("101"))
           .isEqualTo(new Room("101", "Deluxe Suite"));
   }
   ...
   public void testDeleteRoom() {
       ...
       assertThat(roomRepository.findById("202"))
           .isNull();
   }
}
